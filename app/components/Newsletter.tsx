      ...
      <header className="header">
        <div className="header-content">
          <div className="header-item">
            <img src="/image 164.png" alt="Artist Designed" />
