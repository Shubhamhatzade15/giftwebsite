  ...
  return (
    ...
    <div className="gift-wrap-selection">
      ...
      <div className="gift-wrap-option">
        <img src="/image 182.png" alt="Step 1" className="gift-wrap-image" />
      ...
      <div className="gift-wrap-option">
        <img src="/image 183.png" alt="Step 2" className="gift-wrap-image" />
        <div className="gift-wrap-text">
          <h2>Step 2</h2>
      ...
      <div className="gift-wrap-option">
        <img src="/image 185.png" alt="Step 3" className="gift-wrap-image" />
        <div className="gift-wrap-text">
          <h2>Step 3</h2>
      ...
      <div className="gift-wrap-option">
        <img src="/image 184.png" alt="Step 4" className="gift-wrap-image" />
        <div className="gift-wrap-text">
          <h2>Step 4</h2>
