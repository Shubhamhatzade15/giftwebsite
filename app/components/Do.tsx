...
const Do = () => {
  return (
    <div className="pg2-container-1" style={{ backgroundColor: 'rgb(253, 253, 253)' }}>
        ...
        <div className='pg2-card1'>
          <div className='box-space'>
            <div className=''>
              ...
              <div className='para'>
                <p>We help you understand your customers better</p>
              </div>
            </div>
          </div>
          <div className='ancho-pg2'>
        ...
        <div className='pg2-card1'>
          <div className='box-space'>
            <div className=''>
              ...
              <div className='head'>
                <h1>Optimize Operations</h1>
              </div>
              <div className='para'>
                <p>We help you streamline your business operations</p>
              </div>
            </div>
          </div>
          <div className='ancho-pg2'>
